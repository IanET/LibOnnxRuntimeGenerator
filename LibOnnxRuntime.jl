...
SessionGetInputCount(apis::OrtApi, session, out) = ccall(Base.getproperty(apis, :SessionGetInputCount), OrtStatusPtr, (Ptr{OrtSession}, Ptr{Csize_t}), session, out)
SessionGetOutputCount(apis::OrtApi, session, out) = ccall(Base.getproperty(apis, :SessionGetOutputCount), OrtStatusPtr, (Ptr{OrtSession}, Ptr{Csize_t}), session, out)
SessionGetOverridableInitializerCount(apis::OrtApi, session, out) = ccall(Base.getproperty(apis, :SessionGetOverridableInitializerCount), OrtStatusPtr, (Ptr{OrtSession}, Ptr{Csize_t}), session, out)
SessionGetInputTypeInfo(apis::OrtApi, session, index, type_info) = ccall(Base.getproperty(apis, :SessionGetInputTypeInfo), OrtStatusPtr, (Ptr{OrtSession}, Csize_t, Ptr{Ptr{OrtTypeInfo}}), session, index, type_info)
SessionGetOutputTypeInfo(apis::OrtApi, session, index, type_info) = ccall(Base.getproperty(apis, :SessionGetOutputTypeInfo), OrtStatusPtr, (Ptr{OrtSession}, Csize_t, Ptr{Ptr{OrtTypeInfo}}), session, index, type_info)
SessionGetOverridableInitializerTypeInfo(apis::OrtApi, session, index, type_info) = ccall(Base.getproperty(apis, :SessionGetOverridableInitializerTypeInfo), OrtStatusPtr, (Ptr{OrtSession}, Csize_t, Ptr{Ptr{OrtTypeInfo}}), session, index, type_info)
SessionGetInputName(apis::OrtApi, session, index, allocator, value) = ccall(Base.getproperty(apis, :SessionGetInputName), OrtStatusPtr, (Ptr{OrtSession}, Csize_t, Ptr{OrtAllocator}, Ptr{Ptr{Cchar}}), session, index, allocator, value)
SessionGetOutputName(apis::OrtApi, session, index, allocator, value) = ccall(Base.getproperty(apis, :SessionGetOutputName), OrtStatusPtr, (Ptr{OrtSession}, Csize_t, Ptr{OrtAllocator}, Ptr{Ptr{Cchar}}), session, index, allocator, value)
SessionGetOverridableInitializerName(apis::OrtApi, session, index, allocator, value) = ccall(Base.getproperty(apis, :SessionGetOverridableInitializerName), OrtStatusPtr, (Ptr{OrtSession}, Csize_t, Ptr{OrtAllocator}, Ptr{Ptr{Cchar}}), session, index, allocator, value)
...
CreateTensorAsOrtValue(apis::OrtApi, allocator, shape, shape_len, type, out) = ccall(Base.getproperty(apis, :CreateTensorAsOrtValue), OrtStatusPtr, (Ptr{OrtAllocator}, Ptr{Int64}, Csize_t, ONNXTensorElementDataType, Ptr{Ptr{OrtValue}}), allocator, shape, shape_len, type, out)
CreateTensorWithDataAsOrtValue(apis::OrtApi, info, p_data, p_data_len, shape, shape_len, type, out) = ccall(Base.getproperty(apis, :CreateTensorWithDataAsOrtValue), OrtStatusPtr, (Ptr{OrtMemoryInfo}, Ptr{Cvoid}, Csize_t, Ptr{Int64}, Csize_t, ONNXTensorElementDataType, Ptr{Ptr{OrtValue}}), info, p_data, p_data_len, shape, shape_len, type, out)
...
FillStringTensor(apis::OrtApi, value, s, s_len) = ccall(Base.getproperty(apis, :FillStringTensor), OrtStatusPtr, (Ptr{OrtValue}, Ptr{Ptr{Cchar}}, Csize_t), value, s, s_len)
GetStringTensorDataLength(apis::OrtApi, value, len) = ccall(Base.getproperty(apis, :GetStringTensorDataLength), OrtStatusPtr, (Ptr{OrtValue}, Ptr{Csize_t}), value, len)
GetStringTensorContent(apis::OrtApi, value, s, s_len, offsets, offsets_len) = ccall(Base.getproperty(apis, :GetStringTensorContent), OrtStatusPtr, (Ptr{OrtValue}, Ptr{Cvoid}, Csize_t, Ptr{Csize_t}, Csize_t), value, s, s_len, offsets, offsets_len)
...
GetOnnxTypeFromTypeInfo(apis::OrtApi, type_info, out) = ccall(Base.getproperty(apis, :GetOnnxTypeFromTypeInfo), OrtStatusPtr, (Ptr{OrtTypeInfo}, Ptr{ONNXType}), type_info, out)
...
SetTensorElementType(apis::OrtApi, info, type) = ccall(Base.getproperty(apis, :SetTensorElementType), OrtStatusPtr, (Ptr{OrtTensorTypeAndShapeInfo}, ONNXTensorElementDataType), info, type)
SetDimensions(apis::OrtApi, info, dim_values, dim_count) = ccall(Base.getproperty(apis, :SetDimensions), OrtStatusPtr, (Ptr{OrtTensorTypeAndShapeInfo}, Ptr{Int64}, Csize_t), info, dim_values, dim_count)
GetTensorElementType(apis::OrtApi, info, out) = ccall(Base.getproperty(apis, :GetTensorElementType), OrtStatusPtr, (Ptr{OrtTensorTypeAndShapeInfo}, Ptr{ONNXTensorElementDataType}), info, out)
GetDimensionsCount(apis::OrtApi, info, out) = ccall(Base.getproperty(apis, :GetDimensionsCount), OrtStatusPtr, (Ptr{OrtTensorTypeAndShapeInfo}, Ptr{Csize_t}), info, out)
GetDimensions(apis::OrtApi, info, dim_values, dim_values_length) = ccall(Base.getproperty(apis, :GetDimensions), OrtStatusPtr, (Ptr{OrtTensorTypeAndShapeInfo}, Ptr{Int64}, Csize_t), info, dim_values, dim_values_length)
GetSymbolicDimensions(apis::OrtApi, info, dim_params, dim_params_length) = ccall(Base.getproperty(apis, :GetSymbolicDimensions), OrtStatusPtr, (Ptr{OrtTensorTypeAndShapeInfo}, Ptr{Ptr{Cchar}}, Csize_t), info, dim_params, dim_params_length)
GetTensorShapeElementCount(apis::OrtApi, info, out) = ccall(Base.getproperty(apis, :GetTensorShapeElementCount), OrtStatusPtr, (Ptr{OrtTensorTypeAndShapeInfo}, Ptr{Csize_t}), info, out)
...
GetValueType(apis::OrtApi, value, out) = ccall(Base.getproperty(apis, :GetValueType), OrtStatusPtr, (Ptr{OrtValue}, Ptr{ONNXType}), value, out)
CreateMemoryInfo(apis::OrtApi, name, type, id, mem_type, out) = ccall(Base.getproperty(apis, :CreateMemoryInfo), OrtStatusPtr, (Ptr{Cchar}, OrtAllocatorType, Cint, OrtMemType, Ptr{Ptr{OrtMemoryInfo}}), name, type, id, mem_type, out)
CreateCpuMemoryInfo(apis::OrtApi, type, mem_type, out) = ccall(Base.getproperty(apis, :CreateCpuMemoryInfo), OrtStatusPtr, (OrtAllocatorType, OrtMemType, Ptr{Ptr{OrtMemoryInfo}}), type, mem_type, out)
...
AllocatorAlloc(apis::OrtApi, ort_allocator, size, out) = ccall(Base.getproperty(apis, :AllocatorAlloc), OrtStatusPtr, (Ptr{OrtAllocator}, Csize_t, Ptr{Ptr{Cvoid}}), ort_allocator, size, out)
...
AllocatorGetInfo(apis::OrtApi, ort_allocator, out) = ccall(Base.getproperty(apis, :AllocatorGetInfo), OrtStatusPtr, (Ptr{OrtAllocator}, Ptr{Ptr{OrtMemoryInfo}}), ort_allocator, out)
...
AddFreeDimensionOverride(apis::OrtApi, options, dim_denotation, dim_value) = ccall(Base.getproperty(apis, :AddFreeDimensionOverride), OrtStatusPtr, (Ptr{OrtSessionOptions}, Ptr{Cchar}, Int64), options, dim_denotation, dim_value)
...
GetValueCount(apis::OrtApi, value, out) = ccall(Base.getproperty(apis, :GetValueCount), OrtStatusPtr, (Ptr{OrtValue}, Ptr{Csize_t}), value, out)
CreateValue(apis::OrtApi, in, num_values, value_type, out) = ccall(Base.getproperty(apis, :CreateValue), OrtStatusPtr, (Ptr{Ptr{OrtValue}}, Csize_t, ONNXType, Ptr{Ptr{OrtValue}}), in, num_values, value_type, out)
CreateOpaqueValue(apis::OrtApi, domain_name, type_name, data_container, data_container_size, out) = ccall(Base.getproperty(apis, :CreateOpaqueValue), OrtStatusPtr, (Ptr{Cchar}, Ptr{Cchar}, Ptr{Cvoid}, Csize_t, Ptr{Ptr{OrtValue}}), domain_name, type_name, data_container, data_container_size, out)
GetOpaqueValue(apis::OrtApi, domain_name, type_name, in, data_container, data_container_size) = ccall(Base.getproperty(apis, :GetOpaqueValue), OrtStatusPtr, (Ptr{Cchar}, Ptr{Cchar}, Ptr{OrtValue}, Ptr{Cvoid}, Csize_t), domain_name, type_name, in, data_container, data_container_size)
...
KernelInfoGetAttribute_int64(apis::OrtApi, info, name, out) = ccall(Base.getproperty(apis, :KernelInfoGetAttribute_int64), OrtStatusPtr, (Ptr{OrtKernelInfo}, Ptr{Cchar}, Ptr{Int64}), info, name, out)
KernelInfoGetAttribute_string(apis::OrtApi, info, name, out, size) = ccall(Base.getproperty(apis, :KernelInfoGetAttribute_string), OrtStatusPtr, (Ptr{OrtKernelInfo}, Ptr{Cchar}, Ptr{Cchar}, Ptr{Csize_t}), info, name, out, size)
KernelContext_GetInputCount(apis::OrtApi, context, out) = ccall(Base.getproperty(apis, :KernelContext_GetInputCount), OrtStatusPtr, (Ptr{OrtKernelContext}, Ptr{Csize_t}), context, out)
KernelContext_GetOutputCount(apis::OrtApi, context, out) = ccall(Base.getproperty(apis, :KernelContext_GetOutputCount), OrtStatusPtr, (Ptr{OrtKernelContext}, Ptr{Csize_t}), context, out)
KernelContext_GetInput(apis::OrtApi, context, index, out) = ccall(Base.getproperty(apis, :KernelContext_GetInput), OrtStatusPtr, (Ptr{OrtKernelContext}, Csize_t, Ptr{Ptr{OrtValue}}), context, index, out)
KernelContext_GetOutput(apis::OrtApi, context, index, dim_values, dim_count, out) = ccall(Base.getproperty(apis, :KernelContext_GetOutput), OrtStatusPtr, (Ptr{OrtKernelContext}, Csize_t, Ptr{Int64}, Csize_t, Ptr{Ptr{OrtValue}}), context, index, dim_values, dim_count, out)
...
GetDenotationFromTypeInfo(apis::OrtApi, type_info, denotation, len) = ccall(Base.getproperty(apis, :GetDenotationFromTypeInfo), OrtStatusPtr, (Ptr{OrtTypeInfo}, Ptr{Ptr{Cchar}}, Ptr{Csize_t}), type_info, denotation, len)
...
GetMapKeyType(apis::OrtApi, map_type_info, out) = ccall(Base.getproperty(apis, :GetMapKeyType), OrtStatusPtr, (Ptr{OrtMapTypeInfo}, Ptr{ONNXTensorElementDataType}), map_type_info, out)
...
ModelMetadataGetVersion(apis::OrtApi, model_metadata, value) = ccall(Base.getproperty(apis, :ModelMetadataGetVersion), OrtStatusPtr, (Ptr{OrtModelMetadata}, Ptr{Int64}), model_metadata, value)
...
ModelMetadataGetCustomMetadataMapKeys(apis::OrtApi, model_metadata, allocator, keys, num_keys) = ccall(Base.getproperty(apis, :ModelMetadataGetCustomMetadataMapKeys), OrtStatusPtr, (Ptr{OrtModelMetadata}, Ptr{OrtAllocator}, Ptr{Ptr{Ptr{Cchar}}}, Ptr{Int64}), model_metadata, allocator, keys, num_keys)
AddFreeDimensionOverrideByName(apis::OrtApi, options, dim_name, dim_value) = ccall(Base.getproperty(apis, :AddFreeDimensionOverrideByName), OrtStatusPtr, (Ptr{OrtSessionOptions}, Ptr{Cchar}, Int64), options, dim_name, dim_value)
...
GetStringTensorElementLength(apis::OrtApi, value, index, out) = ccall(Base.getproperty(apis, :GetStringTensorElementLength), OrtStatusPtr, (Ptr{OrtValue}, Csize_t, Ptr{Csize_t}), value, index, out)
GetStringTensorElement(apis::OrtApi, value, s_len, index, s) = ccall(Base.getproperty(apis, :GetStringTensorElement), OrtStatusPtr, (Ptr{OrtValue}, Csize_t, Csize_t, Ptr{Cvoid}), value, s_len, index, s)
FillStringTensorElement(apis::OrtApi, value, s, index) = ccall(Base.getproperty(apis, :FillStringTensorElement), OrtStatusPtr, (Ptr{OrtValue}, Ptr{Cchar}, Csize_t), value, s, index)
...
GetBoundOutputNames(apis::OrtApi, binding_ptr, allocator, buffer, lengths, count) = ccall(Base.getproperty(apis, :GetBoundOutputNames), OrtStatusPtr, (Ptr{OrtIoBinding}, Ptr{OrtAllocator}, Ptr{Ptr{Cchar}}, Ptr{Ptr{Csize_t}}, Ptr{Csize_t}), binding_ptr, allocator, buffer, lengths, count)
GetBoundOutputValues(apis::OrtApi, binding_ptr, allocator, output, output_count) = ccall(Base.getproperty(apis, :GetBoundOutputValues), OrtStatusPtr, (Ptr{OrtIoBinding}, Ptr{OrtAllocator}, Ptr{Ptr{Ptr{OrtValue}}}, Ptr{Csize_t}), binding_ptr, allocator, output, output_count)
...
TensorAt(apis::OrtApi, value, location_values, location_values_count, out) = ccall(Base.getproperty(apis, :TensorAt), OrtStatusPtr, (Ptr{OrtValue}, Ptr{Int64}, Csize_t, Ptr{Ptr{Cvoid}}), value, location_values, location_values_count, out)
...
SessionGetProfilingStartTimeNs(apis::OrtApi, session, out) = ccall(Base.getproperty(apis, :SessionGetProfilingStartTimeNs), OrtStatusPtr, (Ptr{OrtSession}, Ptr{UInt64}), session, out)
...
CreateEnvWithCustomLoggerAndGlobalThreadPools(apis::OrtApi, logging_function, logger_param, log_severity_level, logid, tp_options, out) = ccall(Base.getproperty(apis, :CreateEnvWithCustomLoggerAndGlobalThreadPools), OrtStatusPtr, (OrtLoggingFunction, Ptr{Cvoid}, OrtLoggingLevel, Ptr{Cchar}, Ptr{OrtThreadingOptions}, Ptr{Ptr{OrtEnv}}), logging_function, logger_param, log_severity_level, logid, tp_options, out)
...
CreateArenaCfg(apis::OrtApi, max_mem, arena_extend_strategy, initial_chunk_size_bytes, max_dead_bytes_per_chunk, out) = ccall(Base.getproperty(apis, :CreateArenaCfg), OrtStatusPtr, (Csize_t, Cint, Cint, Cint, Ptr{Ptr{OrtArenaCfg}}), max_mem, arena_extend_strategy, initial_chunk_size_bytes, max_dead_bytes_per_chunk, out)
...
KernelInfoGetAttributeArray_float(apis::OrtApi, info, name, out, size) = ccall(Base.getproperty(apis, :KernelInfoGetAttributeArray_float), OrtStatusPtr, (Ptr{OrtKernelInfo}, Ptr{Cchar}, Ptr{Cfloat}, Ptr{Csize_t}), info, name, out, size)
KernelInfoGetAttributeArray_int64(apis::OrtApi, info, name, out, size) = ccall(Base.getproperty(apis, :KernelInfoGetAttributeArray_int64), OrtStatusPtr, (Ptr{OrtKernelInfo}, Ptr{Cchar}, Ptr{Int64}, Ptr{Csize_t}), info, name, out, size)
CreateArenaCfgV2(apis::OrtApi, arena_config_keys, arena_config_values, num_keys, out) = ccall(Base.getproperty(apis, :CreateArenaCfgV2), OrtStatusPtr, (Ptr{Ptr{Cchar}}, Ptr{Csize_t}, Csize_t, Ptr{Ptr{OrtArenaCfg}}), arena_config_keys, arena_config_values, num_keys, out)
...
CreateSparseTensorAsOrtValue(apis::OrtApi, allocator, dense_shape, dense_shape_len, type, out) = ccall(Base.getproperty(apis, :CreateSparseTensorAsOrtValue), OrtStatusPtr, (Ptr{OrtAllocator}, Ptr{Int64}, Csize_t, ONNXTensorElementDataType, Ptr{Ptr{OrtValue}}), allocator, dense_shape, dense_shape_len, type, out)
FillSparseTensorCoo(apis::OrtApi, ort_value, data_mem_info, values_shape, values_shape_len, values, indices_data, indices_num) = ccall(Base.getproperty(apis, :FillSparseTensorCoo), OrtStatusPtr, (Ptr{OrtValue}, Ptr{OrtMemoryInfo}, Ptr{Int64}, Csize_t, Ptr{Cvoid}, Ptr{Int64}, Csize_t), ort_value, data_mem_info, values_shape, values_shape_len, values, indices_data, indices_num)
FillSparseTensorCsr(apis::OrtApi, ort_value, data_mem_info, values_shape, values_shape_len, values, inner_indices_data, inner_indices_num, outer_indices_data, outer_indices_num) = ccall(Base.getproperty(apis, :FillSparseTensorCsr), OrtStatusPtr, (Ptr{OrtValue}, Ptr{OrtMemoryInfo}, Ptr{Int64}, Csize_t, Ptr{Cvoid}, Ptr{Int64}, Csize_t, Ptr{Int64}, Csize_t), ort_value, data_mem_info, values_shape, values_shape_len, values, inner_indices_data, inner_indices_num, outer_indices_data, outer_indices_num)
FillSparseTensorBlockSparse(apis::OrtApi, ort_value, data_mem_info, values_shape, values_shape_len, values, indices_shape_data, indices_shape_len, indices_data) = ccall(Base.getproperty(apis, :FillSparseTensorBlockSparse), OrtStatusPtr, (Ptr{OrtValue}, Ptr{OrtMemoryInfo}, Ptr{Int64}, Csize_t, Ptr{Cvoid}, Ptr{Int64}, Csize_t, Ptr{Int32}), ort_value, data_mem_info, values_shape, values_shape_len, values, indices_shape_data, indices_shape_len, indices_data)
CreateSparseTensorWithValuesAsOrtValue(apis::OrtApi, info, p_data, dense_shape, dense_shape_len, values_shape, values_shape_len, type, out) = ccall(Base.getproperty(apis, :CreateSparseTensorWithValuesAsOrtValue), OrtStatusPtr, (Ptr{OrtMemoryInfo}, Ptr{Cvoid}, Ptr{Int64}, Csize_t, Ptr{Int64}, Csize_t, ONNXTensorElementDataType, Ptr{Ptr{OrtValue}}), info, p_data, dense_shape, dense_shape_len, values_shape, values_shape_len, type, out)
UseCooIndices(apis::OrtApi, ort_value, indices_data, indices_num) = ccall(Base.getproperty(apis, :UseCooIndices), OrtStatusPtr, (Ptr{OrtValue}, Ptr{Int64}, Csize_t), ort_value, indices_data, indices_num)
UseCsrIndices(apis::OrtApi, ort_value, inner_data, inner_num, outer_data, outer_num) = ccall(Base.getproperty(apis, :UseCsrIndices), OrtStatusPtr, (Ptr{OrtValue}, Ptr{Int64}, Csize_t, Ptr{Int64}, Csize_t), ort_value, inner_data, inner_num, outer_data, outer_num)
UseBlockSparseIndices(apis::OrtApi, ort_value, indices_shape, indices_shape_len, indices_data) = ccall(Base.getproperty(apis, :UseBlockSparseIndices), OrtStatusPtr, (Ptr{OrtValue}, Ptr{Int64}, Csize_t, Ptr{Int32}), ort_value, indices_shape, indices_shape_len, indices_data)
GetSparseTensorFormat(apis::OrtApi, ort_value, out) = ccall(Base.getproperty(apis, :GetSparseTensorFormat), OrtStatusPtr, (Ptr{OrtValue}, Ptr{OrtSparseFormat}), ort_value, out)
...
GetSparseTensorIndicesTypeShape(apis::OrtApi, ort_value, indices_format, out) = ccall(Base.getproperty(apis, :GetSparseTensorIndicesTypeShape), OrtStatusPtr, (Ptr{OrtValue}, OrtSparseIndicesFormat, Ptr{Ptr{OrtTensorTypeAndShapeInfo}}), ort_value, indices_format, out)
GetSparseTensorIndices(apis::OrtApi, ort_value, indices_format, num_indices, indices) = ccall(Base.getproperty(apis, :GetSparseTensorIndices), OrtStatusPtr, (Ptr{OrtValue}, OrtSparseIndicesFormat, Ptr{Csize_t}, Ptr{Ptr{Cvoid}}), ort_value, indices_format, num_indices, indices)
...
GetExecutionProviderApi(apis::OrtApi, provider_name, version, provider_api) = ccall(Base.getproperty(apis, :GetExecutionProviderApi), OrtStatusPtr, (Ptr{Cchar}, UInt32, Ptr{Ptr{Cvoid}}), provider_name, version, provider_api)
...
UpdateCUDAProviderOptions(apis::OrtApi, cuda_options, provider_options_keys, provider_options_values, num_keys) = ccall(Base.getproperty(apis, :UpdateCUDAProviderOptions), OrtStatusPtr, (Ptr{OrtCUDAProviderOptionsV2}, Ptr{Ptr{Cchar}}, Ptr{Ptr{Cchar}}, Csize_t), cuda_options, provider_options_keys, provider_options_values, num_keys)
...
AddExternalInitializers(apis::OrtApi, options, initializer_names, initializers, num_initializers) = ccall(Base.getproperty(apis, :AddExternalInitializers), OrtStatusPtr, (Ptr{OrtSessionOptions}, Ptr{Ptr{Cchar}}, Ptr{Ptr{OrtValue}}, Csize_t), options, initializer_names, initializers, num_initializers)
...
SessionOptionsAppendExecutionProvider(apis::OrtApi, options, provider_name, provider_options_keys, provider_options_values, num_keys) = ccall(Base.getproperty(apis, :SessionOptionsAppendExecutionProvider), OrtStatusPtr, (Ptr{OrtSessionOptions}, Ptr{Cchar}, Ptr{Ptr{Cchar}}, Ptr{Ptr{Cchar}}, Csize_t), options, provider_name, provider_options_keys, provider_options_values, num_keys)
...
GetTrainingApi(apis::OrtApi, version) = ccall(Base.getproperty(apis, :GetTrainingApi), Ptr{OrtTrainingApi}, (UInt32,), version)
...
UpdateCANNProviderOptions(apis::OrtApi, cann_options, provider_options_keys, provider_options_values, num_keys) = ccall(Base.getproperty(apis, :UpdateCANNProviderOptions), OrtStatusPtr, (Ptr{OrtCANNProviderOptions}, Ptr{Ptr{Cchar}}, Ptr{Ptr{Cchar}}, Csize_t), cann_options, provider_options_keys, provider_options_values, num_keys)
...
KernelInfo_GetInputName(apis::OrtApi, info, index, out, size) = ccall(Base.getproperty(apis, :KernelInfo_GetInputName), OrtStatusPtr, (Ptr{OrtKernelInfo}, Csize_t, Ptr{Cchar}, Ptr{Csize_t}), info, index, out, size)
KernelInfo_GetOutputName(apis::OrtApi, info, index, out, size) = ccall(Base.getproperty(apis, :KernelInfo_GetOutputName), OrtStatusPtr, (Ptr{OrtKernelInfo}, Csize_t, Ptr{Cchar}, Ptr{Csize_t}), info, index, out, size)
KernelInfo_GetInputTypeInfo(apis::OrtApi, info, index, type_info) = ccall(Base.getproperty(apis, :KernelInfo_GetInputTypeInfo), OrtStatusPtr, (Ptr{OrtKernelInfo}, Csize_t, Ptr{Ptr{OrtTypeInfo}}), info, index, type_info)
KernelInfo_GetOutputTypeInfo(apis::OrtApi, info, index, type_info) = ccall(Base.getproperty(apis, :KernelInfo_GetOutputTypeInfo), OrtStatusPtr, (Ptr{OrtKernelInfo}, Csize_t, Ptr{Ptr{OrtTypeInfo}}), info, index, type_info)
...
GetSessionConfigEntry(apis::OrtApi, options, config_key, config_value, size) = ccall(Base.getproperty(apis, :GetSessionConfigEntry), OrtStatusPtr, (Ptr{OrtSessionOptions}, Ptr{Cchar}, Ptr{Cchar}, Ptr{Csize_t}), options, config_key, config_value, size)
...
GetResizedStringTensorElementBuffer(apis::OrtApi, value, index, length_in_bytes, buffer) = ccall(Base.getproperty(apis, :GetResizedStringTensorElementBuffer), OrtStatusPtr, (Ptr{OrtValue}, Csize_t, Csize_t, Ptr{Ptr{Cchar}}), value, index, length_in_bytes, buffer)
...
UpdateROCMProviderOptions(apis::OrtApi, rocm_options, provider_options_keys, provider_options_values, num_keys) = ccall(Base.getproperty(apis, :UpdateROCMProviderOptions), OrtStatusPtr, (Ptr{OrtROCMProviderOptions}, Ptr{Ptr{Cchar}}, Ptr{Ptr{Cchar}}, Csize_t), rocm_options, provider_options_keys, provider_options_values, num_keys)
...
CreateAndRegisterAllocatorV2(apis::OrtApi, env, provider_type, mem_info, arena_cfg, provider_options_keys, provider_options_values, num_keys) = ccall(Base.getproperty(apis, :CreateAndRegisterAllocatorV2), OrtStatusPtr, (Ptr{OrtEnv}, Ptr{Cchar}, Ptr{OrtMemoryInfo}, Ptr{OrtArenaCfg}, Ptr{Ptr{Cchar}}, Ptr{Ptr{Cchar}}, Csize_t), env, provider_type, mem_info, arena_cfg, provider_options_keys, provider_options_values, num_keys)
...
ShapeInferContext_GetInputCount(apis::OrtApi, context, out) = ccall(Base.getproperty(apis, :ShapeInferContext_GetInputCount), OrtStatusPtr, (Ptr{OrtShapeInferContext}, Ptr{Csize_t}), context, out)
ShapeInferContext_GetInputTypeShape(apis::OrtApi, context, index, info) = ccall(Base.getproperty(apis, :ShapeInferContext_GetInputTypeShape), OrtStatusPtr, (Ptr{OrtShapeInferContext}, Csize_t, Ptr{Ptr{OrtTensorTypeAndShapeInfo}}), context, index, info)
...
ShapeInferContext_SetOutputTypeShape(apis::OrtApi, context, index, info) = ccall(Base.getproperty(apis, :ShapeInferContext_SetOutputTypeShape), OrtStatusPtr, (Ptr{OrtShapeInferContext}, Csize_t, Ptr{OrtTensorTypeAndShapeInfo}), context, index, info)
SetSymbolicDimensions(apis::OrtApi, info, dim_params, dim_params_length) = ccall(Base.getproperty(apis, :SetSymbolicDimensions), OrtStatusPtr, (Ptr{OrtTensorTypeAndShapeInfo}, Ptr{Ptr{Cchar}}, Csize_t), info, dim_params, dim_params_length)
ReadOpAttr(apis::OrtApi, op_attr, type, data, len, out) = ccall(Base.getproperty(apis, :ReadOpAttr), OrtStatusPtr, (Ptr{OrtOpAttr}, OrtOpAttrType, Ptr{Cvoid}, Csize_t, Ptr{Csize_t}), op_attr, type, data, len, out)
...
KernelContext_ParallelFor(apis::OrtApi, context, fn, total, num_batch, usr_data) = ccall(Base.getproperty(apis, :KernelContext_ParallelFor), OrtStatusPtr, (Ptr{OrtKernelContext}, Ptr{Cvoid}, Csize_t, Csize_t, Ptr{Cvoid}), context, fn, total, num_batch, usr_data)
SessionOptionsAppendExecutionProvider_OpenVINO_V2(apis::OrtApi, options, provider_options_keys, provider_options_values, num_keys) = ccall(Base.getproperty(apis, :SessionOptionsAppendExecutionProvider_OpenVINO_V2), OrtStatusPtr, (Ptr{OrtSessionOptions}, Ptr{Ptr{Cchar}}, Ptr{Ptr{Cchar}}, Csize_t), options, provider_options_keys, provider_options_values, num_keys)
...
SetEpDynamicOptions(apis::OrtApi, sess, keys, values, kv_len) = ccall(Base.getproperty(apis, :SetEpDynamicOptions), OrtStatusPtr, (Ptr{OrtSession}, Ptr{Ptr{Cchar}}, Ptr{Ptr{Cchar}}, Csize_t), sess, keys, values, kv_len)
...
HardwareDevice_VendorId(apis::OrtApi, device) = ccall(Base.getproperty(apis, :HardwareDevice_VendorId), UInt32, (Ptr{OrtHardwareDevice},), device)
...
HardwareDevice_DeviceId(apis::OrtApi, device) = ccall(Base.getproperty(apis, :HardwareDevice_DeviceId), UInt32, (Ptr{OrtHardwareDevice},), device)
...
GetTensorSizeInBytes(apis::OrtApi, ort_value, size) = ccall(Base.getproperty(apis, :GetTensorSizeInBytes), OrtStatusPtr, (Ptr{OrtValue}, Ptr{Csize_t}), ort_value, size)
...
CreateMemoryInfo_V2(apis::OrtApi, name, device_type, vendor_id, device_id, mem_type, alignment, allocator_type, out) = ccall(Base.getproperty(apis, :CreateMemoryInfo_V2), OrtStatusPtr, (Ptr{Cchar}, OrtMemoryInfoDeviceType, UInt32, Int32, OrtDeviceMemoryType, Csize_t, OrtAllocatorType, Ptr{Ptr{OrtMemoryInfo}}), name, device_type, vendor_id, device_id, mem_type, alignment, allocator_type, out)
...
MemoryInfoGetVendorId(apis::OrtApi, ptr) = ccall(Base.getproperty(apis, :MemoryInfoGetVendorId), UInt32, (Ptr{OrtMemoryInfo},), ptr)
ValueInfo_GetValueProducer(apis::OrtApi, value_info, producer_node, producer_output_index) = ccall(Base.getproperty(apis, :ValueInfo_GetValueProducer), OrtStatusPtr, (Ptr{OrtValueInfo}, Ptr{Ptr{OrtNode}}, Ptr{Csize_t}), value_info, producer_node, producer_output_index)
ValueInfo_GetValueNumConsumers(apis::OrtApi, value_info, num_consumers) = ccall(Base.getproperty(apis, :ValueInfo_GetValueNumConsumers), OrtStatusPtr, (Ptr{OrtValueInfo}, Ptr{Csize_t}), value_info, num_consumers)
ValueInfo_GetValueConsumers(apis::OrtApi, value_info, nodes, input_indices, num_consumers) = ccall(Base.getproperty(apis, :ValueInfo_GetValueConsumers), OrtStatusPtr, (Ptr{OrtValueInfo}, Ptr{Ptr{OrtNode}}, Ptr{Int64}, Csize_t), value_info, nodes, input_indices, num_consumers)
...
Graph_GetNumInputs(apis::OrtApi, graph, num_inputs) = ccall(Base.getproperty(apis, :Graph_GetNumInputs), OrtStatusPtr, (Ptr{OrtGraph}, Ptr{Csize_t}), graph, num_inputs)
Graph_GetInputs(apis::OrtApi, graph, inputs, num_inputs) = ccall(Base.getproperty(apis, :Graph_GetInputs), OrtStatusPtr, (Ptr{OrtGraph}, Ptr{Ptr{OrtValueInfo}}, Csize_t), graph, inputs, num_inputs)
Graph_GetNumOutputs(apis::OrtApi, graph, num_outputs) = ccall(Base.getproperty(apis, :Graph_GetNumOutputs), OrtStatusPtr, (Ptr{OrtGraph}, Ptr{Csize_t}), graph, num_outputs)
Graph_GetOutputs(apis::OrtApi, graph, outputs, num_outputs) = ccall(Base.getproperty(apis, :Graph_GetOutputs), OrtStatusPtr, (Ptr{OrtGraph}, Ptr{Ptr{OrtValueInfo}}, Csize_t), graph, outputs, num_outputs)
Graph_GetNumInitializers(apis::OrtApi, graph, num_initializers) = ccall(Base.getproperty(apis, :Graph_GetNumInitializers), OrtStatusPtr, (Ptr{OrtGraph}, Ptr{Csize_t}), graph, num_initializers)
Graph_GetInitializers(apis::OrtApi, graph, initializers, num_initializers) = ccall(Base.getproperty(apis, :Graph_GetInitializers), OrtStatusPtr, (Ptr{OrtGraph}, Ptr{Ptr{OrtValueInfo}}, Csize_t), graph, initializers, num_initializers)
Graph_GetNumNodes(apis::OrtApi, graph, num_nodes) = ccall(Base.getproperty(apis, :Graph_GetNumNodes), OrtStatusPtr, (Ptr{OrtGraph}, Ptr{Csize_t}), graph, num_nodes)
Graph_GetNodes(apis::OrtApi, graph, nodes, num_nodes) = ccall(Base.getproperty(apis, :Graph_GetNodes), OrtStatusPtr, (Ptr{OrtGraph}, Ptr{Ptr{OrtNode}}, Csize_t), graph, nodes, num_nodes)
...
Graph_GetGraphView(apis::OrtApi, src_graph, nodes, num_nodes, dst_graph) = ccall(Base.getproperty(apis, :Graph_GetGraphView), OrtStatusPtr, (Ptr{OrtGraph}, Ptr{Ptr{OrtNode}}, Csize_t, Ptr{Ptr{OrtGraph}}), src_graph, nodes, num_nodes, dst_graph)
Node_GetId(apis::OrtApi, node, node_id) = ccall(Base.getproperty(apis, :Node_GetId), OrtStatusPtr, (Ptr{OrtNode}, Ptr{Csize_t}), node, node_id)
...
Node_GetNumInputs(apis::OrtApi, node, num_inputs) = ccall(Base.getproperty(apis, :Node_GetNumInputs), OrtStatusPtr, (Ptr{OrtNode}, Ptr{Csize_t}), node, num_inputs)
Node_GetInputs(apis::OrtApi, node, inputs, num_inputs) = ccall(Base.getproperty(apis, :Node_GetInputs), OrtStatusPtr, (Ptr{OrtNode}, Ptr{Ptr{OrtValueInfo}}, Csize_t), node, inputs, num_inputs)
Node_GetNumOutputs(apis::OrtApi, node, num_outputs) = ccall(Base.getproperty(apis, :Node_GetNumOutputs), OrtStatusPtr, (Ptr{OrtNode}, Ptr{Csize_t}), node, num_outputs)
Node_GetOutputs(apis::OrtApi, node, outputs, num_outputs) = ccall(Base.getproperty(apis, :Node_GetOutputs), OrtStatusPtr, (Ptr{OrtNode}, Ptr{Ptr{OrtValueInfo}}, Csize_t), node, outputs, num_outputs)
Node_GetNumImplicitInputs(apis::OrtApi, node, num_implicit_inputs) = ccall(Base.getproperty(apis, :Node_GetNumImplicitInputs), OrtStatusPtr, (Ptr{OrtNode}, Ptr{Csize_t}), node, num_implicit_inputs)
Node_GetImplicitInputs(apis::OrtApi, node, implicit_inputs, num_implicit_inputs) = ccall(Base.getproperty(apis, :Node_GetImplicitInputs), OrtStatusPtr, (Ptr{OrtNode}, Ptr{Ptr{OrtValueInfo}}, Csize_t), node, implicit_inputs, num_implicit_inputs)
Node_GetNumAttributes(apis::OrtApi, node, num_attributes) = ccall(Base.getproperty(apis, :Node_GetNumAttributes), OrtStatusPtr, (Ptr{OrtNode}, Ptr{Csize_t}), node, num_attributes)
Node_GetAttributes(apis::OrtApi, node, attributes, num_attributes) = ccall(Base.getproperty(apis, :Node_GetAttributes), OrtStatusPtr, (Ptr{OrtNode}, Ptr{Ptr{OrtOpAttr}}, Csize_t), node, attributes, num_attributes)
...
Node_GetNumSubgraphs(apis::OrtApi, node, num_subgraphs) = ccall(Base.getproperty(apis, :Node_GetNumSubgraphs), OrtStatusPtr, (Ptr{OrtNode}, Ptr{Csize_t}), node, num_subgraphs)
Node_GetSubgraphs(apis::OrtApi, node, subgraphs, num_subgraphs, attribute_names) = ccall(Base.getproperty(apis, :Node_GetSubgraphs), OrtStatusPtr, (Ptr{OrtNode}, Ptr{Ptr{OrtGraph}}, Csize_t, Ptr{Ptr{Cchar}}), node, subgraphs, num_subgraphs, attribute_names)
...
SessionGetMemoryInfoForInputs(apis::OrtApi, session, inputs_memory_info, num_inputs) = ccall(Base.getproperty(apis, :SessionGetMemoryInfoForInputs), OrtStatusPtr, (Ptr{OrtSession}, Ptr{Ptr{OrtMemoryInfo}}, Csize_t), session, inputs_memory_info, num_inputs)
SessionGetMemoryInfoForOutputs(apis::OrtApi, session, outputs_memory_info, num_outputs) = ccall(Base.getproperty(apis, :SessionGetMemoryInfoForOutputs), OrtStatusPtr, (Ptr{OrtSession}, Ptr{Ptr{OrtMemoryInfo}}, Csize_t), session, outputs_memory_info, num_outputs)
SessionGetEpDeviceForInputs(apis::OrtApi, session, inputs_ep_devices, num_inputs) = ccall(Base.getproperty(apis, :SessionGetEpDeviceForInputs), OrtStatusPtr, (Ptr{OrtSession}, Ptr{Ptr{OrtEpDevice}}, Csize_t), session, inputs_ep_devices, num_inputs)
